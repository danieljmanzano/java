...
// para exercício de POO, temos que "replicar" todos os códigos (ou pelo menos a função deles) em python
// então, basicamente, não fiz nada disso aqui não, to colocando aqui pra salvar. fornecido pelo professor
